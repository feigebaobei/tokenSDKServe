...
let initWS = () => {
  ...
  ws.on('message', (msg) => {
    ...
    if (config.messagefn) {
      ...
      ws.send(createMessage({messageId: mid}, [], 'receipt'))
    }
  })
  ws.on('error', (e) => {
...
let setConfig = ({openfn = null, messagefn = null, errorfn = null, closefn = null, reConnectGap = null, isProd = false}) => {
  // if (url) {
  //   config.url = url
  // }
  // if (did) {
...
// websocket实例
let wsc = ({openfn = null, messagefn = null, errorfn = null, closefn = null, reConnectGap = null, isProd = false}) => {
  setConfig({openfn: openfn, messagefn: messagefn, errorfn: errorfn, closefn: closefn, reConnectGap: reConnectGap, isProd: isProd})
  return initWS()
}
// let wsc = ({openfn = null, messagefn = null, errorfn = null, closefn = null, reConnectGap = null, isProd = false}) => {
//   setConfig({reConnectGap, isProd})
//   return initWS()
// }
